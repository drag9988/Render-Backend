...
let AppService = class AppService {
    ...
    async convertLibreOffice(file, format) {
        ...
        await this.execAsync(`libreoffice --headless --convert-to ${format} --outdir /tmp ${tempInput}`);
    ...
    async compressPdf(file) {
        ...
        await this.execAsync(`gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/ebook -dNOPAUSE -dQUIET -dBATCH -sOutputFile=${output} ${input}`);
